...
const INITIAL_STATE = {
  ...
  rest_length: 1,
  is_running: false,
  task_list: [ // testing purposes only
    {
      hours: 0,
      minutes: 1,
...
class App extends Component {
  ...
  _addTaskToList = task_obj => {
    this.setState(prevState => ({task_list: prevState.task_list.concat(task_obj)}))
  }
...
*/
  ...
  _createItemID = (item_index = this.state.task_list.length) => item_index + 1

  _promote = (arr_in = this.state.task_list) => {}
      ...
      <div className="App container-fluid">
        ...
        <AppWrapper className="row no-gutters d-xs-flex-column d-sm-flex-row">
          <ControlWrapper
            ...
            createItemID={this._createItemID}
          />
